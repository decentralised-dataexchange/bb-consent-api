...
func GetRbacPolicies() [][]string {
	...
	policies := [][]string{
		...
		{"organisation_admin", "/v2/config/data-agreement/{dataAgreementId}/attributes", "GET"},
		{"organisation_admin", "/v2/config/data-agreements/attribute", "POST"},
		{"organisation_admin", "/v2/config/data-agreements/attribute/{attributeId}", "PUT"},
		{"organisation_admin", "/v2/config/data-agreements/attributes", "GET"},
		...
		{"user", "/v2/service/data-agreement/{dataAgreementId}/attributes", "GET"},
